...
if __name__ == "__main__":
    # Dynamically load .env configuration if present
    from pathlib import Path
    for p in [Path(".env"), Path("digiswasthya_migration/.env")]:
        if p.exists():
    ...
    target_file = os.getenv("INPUT_EXCEL_PATH") or EXCEL_FILE_PATH
    search_excel(target_file, SEARCH_PHONES)
